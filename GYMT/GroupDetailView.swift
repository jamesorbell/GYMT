...
struct GroupDetailView: View {
    ...
    let modelData3: [User] =
    [User(username: "jorbell", displayname: "James Orbell", coins: 7384),
    User(username: "anitabieda", displayname: "Anita Bieda", coins: 2837),
    User(username: "josheastwell", displayname: "Josh Eastwell", coins: 5748),
    User(username: "maddybrice", displayname: "Maddy Brice", coins: 3948),]
