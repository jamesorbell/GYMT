...
struct ChallengeDetailView: View {
    ...
    let modelData2: [User] =
        [User(username: "jorbell", displayname: "James Orbell", coins: 783),
        User(username: "anitabieda", displayname: "Anita Bieda", coins: 823),
        User(username: "josheastwell", displayname: "Josh Eastwell", coins: 123),
        User(username: "maddybrice", displayname: "Maddy Brice", coins: 243),]
